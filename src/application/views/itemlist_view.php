    ...
    <section class="shop__filter filter">
      ...
      <div class="filter__wrapper">
        ...
        <ul class="filter__list">
          <li>
            <a class="filter__list-item active" id="categoryAllItemList" href="javascript://">Все</a>
          </li>
          <li>
            <a class="filter__list-item" href="javascript://" id="categoryWomanItemList">Женщины</a>
          </li>
          <li>
            <a class="filter__list-item" href="javascript://" id="categoryManItemList">Мужчины</a>
          </li>
          <li>
            <a class="filter__list-item" href="javascript://" id="categoryChildrenItemList">Дети</a>
          </li>
          <li>
            <a class="filter__list-item" href="javascript://" id="categoryAccItemList">Аксессуары</a>
          </li>
        </ul>
      </div>
        <div class="filter__wrapper">
...
<!-- вывод товаров---------- ------------------------------------>
      <!-----<section class="itemListWrapper"---->
          <div class="itemListelement" style="width: 860px;">
              <p class="itemListId">ID</p>
              <p class="itemListName">Название</p>
              <p class="itemListPrice">Цена</p>
          </div>
      <section class="itemListWrapper" id="itemsList">
